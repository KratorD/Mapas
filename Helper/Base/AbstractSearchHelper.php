...
abstract class AbstractSearchHelper implements SearchableInterface
{
    ...
    {
        if (!$this->permissionApi->hasPermission('TdMMapsModule::', '::', ACCESS_READ)) {
            return '';
        }
    ...
    public function getResults(array $words, $searchType = 'AND', $modVars = null)
    {
        ...
        foreach ($searchTypes as $searchTypeCode => $typeInfo) {
            ...
            if (isset($moduleActivationInfo['TdMMapsModule'])) {
                $moduleActivationInfo = $moduleActivationInfo['TdMMapsModule'];
            ...
            switch ($objectType) {
                case 'map':
                    ...
                    $whereArray[] = 'tbl.mapFile';
                    $whereArray[] = 'tbl.testState';
                    $whereArray[] = 'tbl.game';
                    $whereArray[] = 'tbl.sizeMap';
                    $whereArray[] = 'tbl.languageMap';
                    $whereArray[] = 'tbl.versionMap';
                    $whereArray[] = 'tbl.difficulty';
                    $whereArray[] = 'tbl.gameType';
                    $whereArray[] = 'tbl.mapStyle';
                    $whereArray[] = 'tbl.description';
                    $whereArray[] = 'tbl.foreground';
                    $whereArray[] = 'tbl.underground';
                    break;
            }
            ...
            foreach ($entities as $entity) {
                ...
                if (!$this->permissionApi->hasPermission('TdMMapsModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', ACCESS_OVERVIEW)) {
                    continue;
                }
                ...
                if ($hasDisplayAction) {
                    ...
                    $displayUrl = new RouteUrl('tdmmapsmodule_' . strtolower($objectType) . '_display', $urlArgs);
                }
    
                $result = new SearchResultEntity();
                $result->setTitle($formattedTitle)
                    ->setText($description)
                    ->setModule('TdMMapsModule')
                    ->setCreated($created)
