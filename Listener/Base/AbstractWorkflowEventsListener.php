...
use TdM\MapsModule\Helper\NotificationHelper;
...
abstract class AbstractWorkflowEventsListener implements EventSubscriberInterface
{
    ...
    public function onGuard(GuardEvent $event)
    {
        ...
        $hasApproval = in_array($objectType, ['map']);
        ...
        if (!$this->permissionApi->hasPermission('TdMMapsModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', $permissionLevel)) {
    ...
    public function onEnter(Event $event)
    {
        ...
        if (in_array($entity->get_objectType(), ['map'])) {
