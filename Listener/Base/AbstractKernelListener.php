...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from maps app';
     *     $event->getRequest()->attributes->set('TdMMapsModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('TdMMapsModule_test');`
     *     now `$testMessage` should be: `'Hello from maps app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('maps App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
