...
namespace TdM\MapsModule\Entity\Repository\Base;
 ...
 *
 * This is the base repository class for map entities.
 */
abstract class AbstractMapRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'TdM\MapsModule\Entity\MapEntity';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'TdMMapsModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'maps', 'userid' => $userId];
     ...
     *
     * @return array|mapEntity Retrieved data array or mapEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved mapEntity instances
     */
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('map', $qb);
        }
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('map', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numMaps';
        if (true === $useJoins) {
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('map', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of maps to exclude (optional)
     *
     * @return boolean Result of this check, true if the given map does not already exist
     */
