...
abstract class AbstractMapEntity extends EntityAccess
{
     ...
     * @var string $gameType
     */
    protected $gameType = 'Single';
    
    /**
     * @ORM\Column(length=235)
     * @Assert\NotBlank()
     * @MapsAssert\ListEntry(entityName="map", propertyName="mapStyle", multiple=true)
     * @var string $mapStyle
     */
    protected $mapStyle = '';
    ...
    public function setCreateDat($createDat)
    {
        if ($this->createDat !== $createDat) {
            if (!(null == $createDat && empty($createDat)) && !(is_object($createDat) && $createDat instanceOf \DateTime)) {
                $createDat = new \DateTime($createDat);
            }
            
            if (null === $createDat || empty($createDat)) {
