...
class MapController extends AbstractMapController
{
    ...
    public function indexAction(Request $request)
    {
		...
		// Last 10 maps approved
		/*$lastTen = ModUtil::apiFunc('Maps', 'user', 'getall', array(
                    'mapState' => 'Comprobado',
					'sort'     => 'createdTime',
					'limit'    => '10'
        ));*/
		//$menuEntityFactory = $this->get('tdm_maps_module.entity_factory');
    ...
    public function editAction(Request $request)
    {
        ...
        //print_r($templateParameters);die();
        // fetch and return the appropriate template
        return $this->get('tdm_maps_module.view_helper')->processTemplate($objectType, 'edit', $templateParameters, '@TdMMapsModule/Custom/edit.html.twig');
    }
    /**
     * @inheritDoc
     *
