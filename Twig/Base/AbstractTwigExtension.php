...
namespace TdM\MapsModule\Twig\Base;
...
use TdM\MapsModule\Helper\EntityDisplayHelper;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('tdmmapsmodule_moderationObjects', [$this, 'getModerationObjects']),
            new \Twig_SimpleFunction('tdmmapsmodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('tdmmapsmodule_templateSelector', [$this, 'getTemplateSelector'])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('tdmmapsmodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('tdmmapsmodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('tdmmapsmodule_formattedTitle', [$this, 'getFormattedEntityTitle']),
            new \Twig_SimpleFilter('tdmmapsmodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The tdmmapsmodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|tdmmapsmodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|tdmmapsmodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The tdmmapsmodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|tdmmapsmodule_fileSize }}
     *
    ...
    /**
     * The tdmmapsmodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|tdmmapsmodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The tdmmapsmodule_moderationObjects function determines the amount of unapproved objects.
    ...
    /**
     * The tdmmapsmodule_objectTypeSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The tdmmapsmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The tdmmapsmodule_formattedTitle filter outputs a formatted title for a given entity.
     * Example:
     *     {{ myPost|tdmmapsmodule_formattedTitle }}
     *
